...
/**
 * Частота источника ~: второй номинал рядом с амплитудой. Отдельная форма,
 * а не продолжение поля «Амплитуда», потому что у величин разные единицы —
 * у каждой своя подсказка парсера (В и Гц).
 */
