...
function числовойВопросМ1(): NumericQuestion {
  const найденный = module1.tasks.find(
    (задание): задание is NumericQuestion => задание.kind === 'numeric-question',
  );
  if (!найденный) throw new Error('фикстура: в М1 ожидается числовой Вопрос');
  return найденный;
}

const вопрос = числовойВопросМ1();
